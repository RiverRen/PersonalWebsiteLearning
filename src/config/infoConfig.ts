...
// personal info
export const name = 'RiverRen Tsao'
export const headline = 'Undergraduate in PKU majoring in Psychology & Cognitive Sciences'
export const introduction =
  "Hi! My name is RiverRen Tsao. I'm from Tianjin."
export const email = 'riverren@stu.pku.edu.cn'
